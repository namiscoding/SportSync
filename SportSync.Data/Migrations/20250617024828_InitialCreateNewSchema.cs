        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultOpeningTime = table.Column<TimeSpan>(type: "TIME", nullable: true),
                    DefaultClosingTime = table.Column<TimeSpan>(type: "TIME", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourtComplexes_SportTypes_SportTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OwnerSubscriptionId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OwnerUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    PlanId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OwnerSubscriptions_AspNetUsers_OwnerUserId",
                        column: x => x.OwnerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OwnerSubscriptions_SubscriptionPlans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourtComplexAmenities", x => new { x.CourtComplexId, x.AmenityId });
                    table.ForeignKey(
                        name: "FK_CourtComplexAmenities_Amenities_AmenityId",
                        column: x => x.AmenityId,
                        principalTable: "Amenities",
                        principalColumn: "AmenityId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourtComplexAmenities_CourtComplexes_CourtComplexId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_CourtComplexes_CourtComplexId",
                        column: x => x.CourtComplexId,
                        principalTable: "CourtComplexes",
                        principalColumn: "CourtComplexId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BlockedSlotId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CourtId = table.Column<int>(type: "int", nullable: false),
                    BlockDate = table.Column<DateTime>(type: "DATE", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookerUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    CourtComplexId = table.Column<int>(type: "int", nullable: false),
                    CourtId = table.Column<int>(type: "int", nullable: false),
                    BookedStartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BookedEndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "HourlyPriceRates",
                columns: table => new
                {
                    HourlyPriceRateId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CourtId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HourlyPriceRates", x => x.HourlyPriceRateId);
                    table.ForeignKey(
                        name: "FK_HourlyPriceRates_Courts_CourtId",
                        column: x => x.CourtId,
                        principalTable: "Courts",
                        principalColumn: "CourtId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingProductId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookingId = table.Column<long>(type: "bigint", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UnitPriceAtTimeOfAddition = table.Column<decimal>(type: "DECIMAL(18,2)", nullable: false),
                    RentalStartTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RentalEndTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Subtotal = table.Column<decimal>(type: "DECIMAL(18,2)", nullable: false),
                    AddedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingProducts", x => x.BookingProductId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourtComplexAmenities_AmenityId",
                table: "CourtComplexAmenities",
                column: "AmenityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourtComplexes_SportTypeId",
                table: "CourtComplexes",
                column: "SportTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HourlyPriceRates_CourtId_DayOfWeek_StartTime",
                table: "HourlyPriceRates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OwnerSubscriptions_OwnerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CourtComplexId",
                table: "Products",
                column: "CourtComplexId");
